...
export default function SerieDetail({ params }: SeriesDetailProps) {
    ...
    useEffect(() => {
      const fetchDataAsync = async () => {
        try {
          const movieDetailData = await fetchData(`/tv/${params.id}`);
          const recommendationsData = await fetchData(`/tv/${params.id}/recommendations`);
